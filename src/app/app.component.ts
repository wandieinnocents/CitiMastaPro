...
@Component({
  ...
  template: `<ion-menu [content]="content" class="masters">
    <ion-header>
      <ion-toolbar color="appcolor">
        <ion-title >Citi Masta</ion-title>
      </ion-toolbar>
    </ion-header>

    <ion-content style="background-color:#f76c26;">
      <ion-list >
        <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)" color="appcolor" style="color:#ffffff;">
      ...
      <ion-title >Citi Masta v1.0 </ion-title>
      </ion-navbar>
...
export class MyApp {
  ...
  pages: any[] = [
    ...
    //  { title: 'Traffic Updates', component: 'UserupdatesPage', icon: 'car'},
      ...
      // { title: 'User Guide', component: 'ListMasterPage', icon: 'information'},
